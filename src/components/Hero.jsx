  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            ...
            Farhan <span className="hidden sm:inline">Khan</span>
            </span>
          </h1>
      ...
      <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-5 items-center md:mt-10 mt-5 md:gap-12">
        <Link target="_blank" to="https://www.linkedin.com/in/mohdfarhan7/">
          <BsLinkedin
            size={30}
        ...
        <Link target="_blank" to="https://github.com/mohdfarhan7">
          <BsGithub
            size={30}
        ...
        <Link target="_blank" to="https://discord.com/channels/">
          <BsDiscord
            size={30}
        ...
        <Link target="_blank" to="https://www.instagram.com/farhan.sdi">
          <BsInstagram
            size={30}
